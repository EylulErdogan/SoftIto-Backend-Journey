...
| **04** | 📚 **BookVerse** | Modern Book Management System developed with **ASP.NET Core Razor Pages**, **ADO.NET**, Authentication, Reporting, PDF and Excel Export. | 📁 [**Go to Repository**](https://github.com/eylulerdogan/04-BookVerse) |
